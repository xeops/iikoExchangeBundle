...
class GroupFields {
       ...
       /** Delivery.CustomerPhone STRING */
       /** Customer phone number */
       /** @var string DeliveryCustomerPhone */
       ...
       const RestorauntGroup = "RestorauntGroup";
		...
		/** RestorauntGroup.Id STRING */
		/** Group */
		/** @var string RestorauntGroupId */
    ...
    {
        return [
            self::WeekInMonthOpen,
            self::WeekInYearOpen,
            self::DayOfWeekOpen,
            self::QuarterOpen,
            self::OpenDateTyped,
            self::CloseTime,
            self::DeliveryCloseTime
        ];
    }
