...
interface CalendarPeriodInterface extends \JsonSerializable
{
	/**
	...
	/**
	 * Получить исходный период для преордов прошлого времени (прошлый год, прошлый интервал)
	 * @return CalendarPeriodInterface
	 */
	public function getParendCalendar(): CalendarPeriodInterface;
	...
	/**
	 * Returns all days in a period in a sorted array
	 * @param bool $toDateTime - true if result should be as \DateTime array
	 * @return CalendarPeriodDay[]|\DateTime[]
	 */
	public function getBreakdownDays($toDateTime = false);
